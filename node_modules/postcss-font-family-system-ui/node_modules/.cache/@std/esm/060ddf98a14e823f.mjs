"main";let postcss;_a14‍.w('postcss',[["default",function(v){postcss=v}]]);let valueParser;_a14‍.w('postcss-value-parser',[["default",function(v){valueParser=v}]]);let flatMap;_a14‍.w('lodash',[["flatMap",function(v){flatMap=v}]]);
...
_a14‍.d(postcss.plugin('postcss-font-family-system-ui', () => {
  return (root) => {
    root.walk(transform())
  }
}));
