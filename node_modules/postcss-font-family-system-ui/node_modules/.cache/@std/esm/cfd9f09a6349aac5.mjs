"main";let postcss;_634‍.w('postcss',[["default",function(v){postcss=v}]]);let valueParser;_634‍.w('postcss-value-parser',[["default",function(v){valueParser=v}]]);let flatMap;_634‍.w('lodash',[["flatMap",function(v){flatMap=v}]]);
...
_634‍.d(postcss.plugin('postcss-font-family-system-ui', () => {
  return (root) => {
    root.walk(transform())
  }
}));
